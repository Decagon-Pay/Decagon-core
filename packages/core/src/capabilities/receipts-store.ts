...
export interface ReceiptsStore {
  ...
  /** Look up an existing receipt by challengeId. Returns null if none found. */
  readonly getReceiptByChallenge: (challengeId: string) => Effect.Effect<Receipt | null, ApiError>;
